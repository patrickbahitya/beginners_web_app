...
<div id="container">
    ...
    <legend class="text-center">Welcome to the Academic Registrar Page</legend>

    <ul class="list-inline label list-group-item">
        <li><a href="register_student_page.php">Register student</a></li>

        <li><a href="registered_students_page.php">view registered students</a></li>
        <li><a href="student_marks_page.php">view student assessment marks</a></li>
